  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-zinc-200 p-6 shadow-sm dark:border-zinc-800" style={{ backgroundColor: "rgba(212,175,55,0.10)" }}>
      ...
      {!token ? (
        ...
        <div className="space-y-4">
          <div className="inline-flex w-full items-center justify-center rounded-xl bg-zinc-900 px-4 py-3 text-sm font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-zinc-100 dark:text-zinc-900" style={{ backgroundColor: "rgba(17, 172, 48, 0.94)" }}>
            {message}
          </div>
