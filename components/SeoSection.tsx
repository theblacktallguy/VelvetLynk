export default function SeoSection() {
  return (
    <div className="card card-muted mt-8 p-6">
      <h3 className="text-base font-semibold">
        Find verified escorts and private connections near you
      </h3>
      ...
      <p className="mt-3 text-sm leading-6 ">
        Verified accounts show a blue badge to help reduce scams and improve
        trust. You can connect directly using phone, email, or WhatsApp where
        available.
      </p>

      <div className="mt-4 text-sm ">
        <span className="font-semibold">Popular searches:</span>{" "}
        Female Escorts • Male Escorts • Female Massage • Male Massage • Platonic
        Dating • Friends with Benefits • Missed Connections • Verified Profiles
        • Escort Listings Nigeria
      </div>
    </div>
  );
}